...
1. Run `uv run pytest --cov yt_dlp_utils --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov yt_dlp_utils --cov-branch --cov-report term-missing:skip-covered`
