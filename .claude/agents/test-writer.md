...
You write comprehensive pytest test suites for yt-dlp-utils. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('yt_dlp_utils.commands.module.some_function')
